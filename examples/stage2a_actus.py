"""Run Stage 2A with the live AAL/ACTUS asset mode."""
...
def main() -> None:
    result = run_stage2_baseline(
        asset_mode="actus",
        output_dir=Path("outputs/stage2a_actus"),
    )
    print("=== Stage-2A ACTUS Asset Mode ===")
    print(
    ...
    print("Outputs written to outputs/stage2a_actus")
