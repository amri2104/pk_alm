"""Run Stage 1 with the live AAL/ACTUS asset mode."""
...
def main() -> None:
    result = run_stage1_baseline(
        asset_mode="actus",
        output_dir=Path("outputs/stage1_actus"),
    )
    print("=== Stage-1 ACTUS Asset Mode ===")
    print(
    ...
    print("Outputs written to outputs/stage1_actus")
